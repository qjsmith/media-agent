...
test_cases = [
    ...
    (
        "/mnt/media/TV Shows/The Simpsons/Season 9/Lisa's Sax.m4v",
        "The Simpsons",
        9,
        None,
        "tv",
    ...
    (
        "/mnt/media/TV Shows/The Simpsons/Season 9/The Simpsons - Lisa's Sax.m4v",
        "The Simpsons",
        9,
        None,
        "tv",
    ...
    (
        "/mnt/media/TV Shows/Steven Universe/Season 5/Steven Universe S05M01 The Movie.m4v",
    ...
    (
        "/mnt/media/TV Shows/Steven Universe/Season 0/Steven Universe S00E01 Pilot.mp4",
        "Steven Universe",
        0,
        1,
        "tv",
    ...
    (
        "/mnt/media/TV Shows/Rick and Morty/Season 3/[Rick.and.Morty.S03E03.Pickle.Rick.1080p.Amazon].WEB-DL.x264-Rapta.mkv",
        "Rick and Morty",
        3,
        3,
        "tv",
    ...
    (
        "/mnt/media/Movies/Love Actually (2003)/Love.Actually.2003.1080p.BluRay.x264.YIFY.mp4",
        "Love Actually",
        None,
        None,
        "movie",
    ...
    (
        "/mnt/media/Movies/The Grand Budapest Hotel (2014)/The.Grand.Budapest.Hotel.2014.1080p.BRRip.x264.mp4",
    ...
    (
        "/mnt/media/TV Shows/Hey Arnold/Season 5/Hey.Arnold.S05E07.avi",
        "Hey Arnold",
        5,
        7,
        "tv",
    ...
    (
        "/mnt/media/TV Shows/Rick and Morty/Season 1/[pseudo] Rick and Morty S01E02 Lawnmower Dog [BDRip] [1080p] [h.265].mkv",
        "Rick and Morty",
        1,
        2,
        "tv",
    ...
    (
        "/mnt/media/TV Shows/Severance/Season 1/Severance.S01E04.720p.ATVP.WEBRip.x264-GalaxyTV.mkv",
        "Severance",
        1,
        4,
        "tv",
    ...
    (
        "/mnt/media/TV Shows/Rick and Morty/Rick and Morty - Season 3 (2017) [1080p]/[Rick.and.Morty.S03E01.The.Rickshank.Rickdemption.1080p.Amazon].WEB-DL.x264-Rapta.mkv",
        "Rick and Morty",
        3,
        1,
        "tv",
    ...
    (
        "/mnt/media/TV Shows/Hey Arnold!/Season.5/Hey.Arnold!_507__Married--.avi",
        "Hey Arnold!",
        5,
        7,
        "tv",
    ...
    (
        "/mnt/media/TV Shows/Hey Arnold!/Season.2/Hey.Arnold!_207__Arnold's.Halloween--[RUS].avi",
        "Hey Arnold!",
        2,
        7,
        "tv",
    ...
    (
        "/mnt/media/TV Shows/Hey Arnold!/Season.3/Hey.Arnold!_303__Casa.Paradiso__Gerald's.Tonsils--[RUS].avi",
        "Hey Arnold!",
        3,
        3,
        "tv",
    ...
    (
        "/mnt/media/TV Shows/The IT Crowd/Version 5.0/The IT Crowd S05 The Internet Is Coming DVDRip BONE.mp4",
        "The IT Crowd",
        5,
        None,
        "tv",
    ...
    (
        "/mnt/media/TV Shows/How I Met Your Mother/How I Met Your Mother Season 6/How I Met Your Mother S06E16 Desperation Day (1080p x265 Joy).mkv",
    ...
    (
        "/mnt/media/Movies/Oceans Eleven (2001)/Oceans.Eleven.2001.1080p.BluRay.H264.AAC-RARBG.mp4",
        "Oceans Eleven",
        None,
        None,
        "movie",
    ...
    (
        "/mnt/media/Movies/The Intouchables (2011)/The.Intouchables.2011.FRENCH.1080p.BluRay.H264.AAC-VXT/The.Intouchables.2011.FRENCH.1080p.BluRay.H264.AAC-VXT.mp4",
        "The Intouchables",
        None,
        None,
        "movie",
    ...
    (
        "/mnt/media/Movies/A Silent Voice (2016)/A.Silent.Voice.2016.1080p.BluRay.x264-[YTS.AM].mp4",
        "A Silent Voice",
        None,
        None,
        "movie",
    ...
    (
        "/mnt/media/TV Shows/The Simpsons/5The Simpsons - Season Five/Homer Goes To College.mp4",
        "The Simpsons",
        5,
        None,
        "tv",
    ...
    (
        "/mnt/media/TV Shows/The Simpsons/5The Simpsons - Season Five/Rosebud.mp4",
        "The Simpsons",
        5,
        None,
        "tv",
    ...
    (
        "/mnt/media/TV Shows/The Simpsons/5The Simpsons - Season Five/Treehouse of Horror IV.mp4",
        "The Simpsons",
        5,
        None,
        "tv",
    ...
    (
        "/mnt/media/Movies/30 for 30/The Birth of Big Air (2009)/The Birth of Big Air (2009).avi",
    ...
    (
        "/mnt/media/Movies/30 for 30/Winning Time Reggie Miller vs The New York Knicks (2010)/Winning Time Reggie Miller vs The New York Knicks (2010).avi",
...
for path, exp_title, exp_season, exp_episode, exp_type in test_cases:
    ...
    ok = (
        parsed["cleaned_title"] == exp_title
        and parsed["season"] == exp_season
        and parsed["episode"] == exp_episode
        and media_type == exp_type
    )
...
for path, exp_title, exp_season, exp_episode, exp_type in test_cases:
    ...
    new_path = (
        build_new_path(result["match"], parsed, media_type) if result["match"] else None
    )
    action = (
        "AUTO RENAME"
    ...
    if action == "LLM/FLAG":
        ...
        print(
            f"  match:    {result['match']['title'] if result['match'] else 'NO MATCH'}"
        )
...
for show_name, season, episode_title, expected_ep in episode_lookup_cases:
    ...
    if got_ep == expected_ep:
        ...
        ep_failed += 1
        print(
            f'✗ FAIL: {show_name} S{season:02d} "{episode_title}" → got={got_ep} expected={expected_ep}'
        )
